...
class Boat:
    ...
    def __init__(self, oars=None, anchor=None, rowlocks=None, weights=None):
    ...
    def set_afloat(self, weather: Weather):
        ...
        if weather.weather_status and self.boat_availability:
            self.is_afloat = True
    ...
    def set_anchor(self):
        ...
        if not self.is_afloat or self.is_anchored or not self.anchor:
            raise ValueError(
                "Лодка не на воде, либо якорь уже установлен/якоря нет")
        self.is_anchored = True
        print("Якорь установлен")
    ...
    def unset_anchor(self):
        ...
        if not self.is_afloat or not self.is_anchored or not self.anchor:
            raise ValueError(
                "Лодка не на воде, либо якорь уже поднят/якоря нет")
        self.is_anchored = False
        print("Якорь поднят, очищен от грязи, уложен в лодку")
    ...
    def check_boat_availability(self, status: str):
        ...
        if status:
            ...
            print("Лодку можно взять")
        else:
            print("Лодку нельзя взять.")
    ...
    def check_capsized(self, status: str):
        ...
        if status:
            self.capsized = True
            print("Лодка перевернулась")
        else:
            print("Лодка не перевернулась")
